...
ifeval::["{language}" == "DE"]
= Topic Backlog fürpass:q[<br><br>]Certified Professional forpass:q[<br>]Software Architecture (CPSA)^(R)^pass:q[<br>]_Expert Level_
:toc-title: Inhaltsverzeichnis
:toc: left
endif::[]

ifeval::["{language}" == "EN"]
= Topic Backlog forpass:q[<br><br>]Certified Professional forpass:q[<br>]Software Architecture (CPSA)^(R)^pass:q[<br>]_Expert Level_
:toc: left
endif::[]
